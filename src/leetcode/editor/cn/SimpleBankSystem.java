...
// 
//
// Related Topics 设计 数组 哈希表 模拟 👍 67 👎 0
...
public class SimpleBankSystem {
    ...
    class Bank {
        ...
        public boolean transfer(int account1, int account2, long money) {
            if(account1 > b.size() || account2 > b.size()) return false;
            if(b.get(account1 - 1) < money) {
                return false;
            }
            b.set(account1 - 1, b.get(account1 - 1) - money);
            b.set(account2 - 1, b.get(account2 - 1) + money);
            return true;
        }

        public boolean deposit(int account, long money) {
            if(account > b.size()) return false;
            b.set(account - 1, b.get(account - 1) + money);
            return true;
        }

        public boolean withdraw(int account, long money) {
            if(account > b.size()) return false;
            if(b.get(account - 1) < money) {
                return false;
            }
            b.set(account - 1, b.get(account - 1) - money);
            return true;
